...
interface TrigonometricFunctions<This : HyperOperation2<This>> : Operation<This> {
    ...
    interface Math<This> : Operation.Math<This> where This : TrigonometricFunctions<This>,
        ...
        fun sin(num: Number): This = with(ZERO) { num.asThis().sin() }
        fun cos(num: Number): This = with(ZERO) { num.asThis().cos() }
        fun tan(num: Number): This = with(ZERO) { num.asThis().tan() }
        fun cot(num: Number): This = with(ZERO) { num.asThis().cot() }
        fun sec(num: Number): This = with(ZERO) { num.asThis().sec() }
        fun csc(num: Number): This = with(ZERO) { num.asThis().csc() }
    }
}